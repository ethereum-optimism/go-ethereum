...
func NewTransactionMeta(l1BlockNumber *big.Int, l1Timestamp uint64, l1MessageSender *common.Address, queueOrigin QueueOrigin, index *uint64, queueIndex *uint64) *TransactionMeta {
