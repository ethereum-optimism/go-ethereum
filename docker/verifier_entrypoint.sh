...
ETH1_ADDRESS_MANAGER_ADDRESS=${ETH1_ADDRESS_MANAGER_ADDRESS:-0x0000000000000000000000000000000000000000}
...
geth --dev \
    ...
    --eth1.addressresolveraddress $ETH1_ADDRESS_MANAGER_ADDRESS \
